...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var drawBoard = this.props.board.grid.map(function (row, rowIdx) {
	      console.log(row);
	      return React.createElement(
	        'div',
	        null,
	        row.map(function (col, colIdx) {
	          return React.createElement(Tile, { tile: col, key: [rowIdx, colIdx], updateGame: _this.props.updateGame });
	        })
	      );
	    });
	    return React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = React.createClass({
	  displayName: 'Tile',
	  setTileText: function setTileText() {
	    var adjacentBombCount = this.props.tile.adjacentBombCount();
