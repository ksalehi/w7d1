...
/***/ function(module, exports, __webpack_require__) {
	...
	var Widgets = React.createClass({
	  ...
	  render: function render() {
	    var tabData = [{ title: "string", content: "asdf" }, { title: "string1", content: "hi" }, { title: "string2", content: "bye" }];
	
	    var searchData = ["gage", "sam", "claire", "ryan", "brooke", "quinn"];
	    ...
	    return React.createElement(
	      ...
	      React.createElement(Autocomplete, { searchData: searchData })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var datas = this.props.tabData.map(function (obj, idx) {
	      var style = '';
	      var isHidden = true;
	      if (_this.state.selectedIndex === idx) {
	        style = 'bold';
	        isHidden = false;
	      }
	      return React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Clock = React.createClass({
	  ...
	  stringify: function stringify(dateObj) {
	  ...
	  render: function render() {
	    return React.createElement(
	      "span",
	      { id: "timer" },
	      this.stringify(this.state.date)
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  successCallback: function successCallback(pos) {
	    this.lat = pos.coords.latitude;
	    this.lon = pos.coords.longitude;
	
	    var xhr = new XMLHttpRequest();
	    var url = 'http://api.openweathermap.org/data/2.5/weather?lat=' + this.lat + '&lon=' + this.lon + '&appid=645c5d39c7603f17e23fcaffcea1a3c1';
	    console.log(url);
	    xhr.open('GET', url);
	    xhr.onload = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Autocomplete = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var searchedNames = this.props.searchData.filter(function (name) {
	      return name.toLowerCase().match(searchString);
	    });
	    return React.createElement(
	      'article',
	      null,
	      React.createElement('input', { type: 'text', onChange: this.handleChange, value: this.state.searchString }),
	      React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          ...
	          searchedNames.map(function (name) {
	            return React.createElement(
	              'li',
